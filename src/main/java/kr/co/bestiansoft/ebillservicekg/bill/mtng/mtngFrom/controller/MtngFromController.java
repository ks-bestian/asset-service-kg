...
public class MtngFromController {
    ...
    @ApiOperation(value = "meeting expected List check", notes = "List Inquiry.")
    ...
    @ApiOperation(value = "meeting expected particular check", notes = "Details Inquiry.")
    ...
    @ApiOperation(value = "meeting expected registration", notes = "meeting expected registration")
    ...
    @ApiOperation(value = "meeting expected - member List check", notes = "meeting expected - member List Inquiry.")
    ...
    @ApiOperation(value = "meeting expected - department(committee) List check", notes = "meeting expected - department(committee) List Inquiry.")
    ...
    @ApiOperation(value = "meeting expected - meeting cancellation", notes = "meeting cancellation")
    ...
    @ApiOperation(value = "meeting expected - Committee The agenda check", notes = "meeting expected - The agenda Inquiry.")
    ...
    @ApiOperation(value = "meeting expected - Plenary The agenda check", notes = "meeting expected - Plenary The agenda Inquiry.")
    ...
    @ApiOperation(value = "meeting expected correction", notes = "intended Meeting Modify")
    ...
    @ApiOperation(value = "Hall Meeting", notes = "meeting expected registration")
    ...
    @ApiOperation(value = "Hall meeting  correction", notes = "Hall Meeting Modify")
    ...
    @ApiOperation(value = "Hall meeting Added agenda", notes = "Hall meeting Agenda Add")
    ...
    @ApiOperation(value = "Hall meeting List check", notes = "List Inquiry.")
    ...
    @ApiOperation(value = "meeting Agenda submit", notes = "meeting Agenda submit")
    ...
    @ApiOperation(value = "Hall meeting Agenda List check", notes = "List Inquiry.")
    ...
    @ApiOperation(value = "Hall Meeting results registration", notes = "meeting result registration")
    ...
    @ApiOperation(value = "Hall Meeting results order change", notes = "Meeting results order change")
    ...
    @ApiOperation(value = "Delete the agenda of the plenary session", notes = "Plenary Delete the agenda ")
