...
public class BaseCodeController {
    ...
    public ResponseEntity<CommonResponse> createBoard(@RequestBody BaseCodeVo baseCodeVo) {
        return new ResponseEntity<>(new CommonResponse(HttpStatus.CREATED.value(), "Board created successfully", basecodeService.createBaseCode(baseCodeVo)), HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<CommonResponse> updateBoard(@RequestBody BaseCodeVo baseCodeVo) {
        return new ResponseEntity<>(new CommonResponse(HttpStatus.OK.value(), "Board updated successfully", basecodeService.updateBaseCode(baseCodeVo)), HttpStatus.CREATED);
    }
